...
public class Dettaglio {
    ...
    public static String getTitolo() {
        return "|" + PrnUtilities.wc(-20, "prodotto") + "|" + PrnUtilities.wc(12, "prezzo") + "|"
                + PrnUtilities.wc(-10, "quantità") + "|" + PrnUtilities.wc(-6, "sconto") + "|€ "
                + PrnUtilities.wc(15, "costo") + "|";
    }

    public String dettaglioVuoto() {
        return "|" + PrnUtilities.wc(-20, prodotto) + "|€ " + PrnUtilities.wc(10, "-") + "|"
                + PrnUtilities.wc(10, quantità) + "|" +PrnUtilities.wc(4, sconto) + "% |€ "
                + PrnUtilities.wc(15, "-") + "|";
    }

    public String toString() {
        return "|" + PrnUtilities.wc(-20, prodotto) + "|€ " + PrnUtilities.wc(10, prezzo) + "|"
                + PrnUtilities.wc(10, quantità) + "|" + PrnUtilities.wc(4, sconto) + "% |€ "
